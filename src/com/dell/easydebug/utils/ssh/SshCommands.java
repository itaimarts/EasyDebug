...
public class SshCommands {
    ...
    public static final String INSERT_TOMCAT_DEBUG_CONFIGURATION =
            "sed -i 's/-XX:HeapDumpPath=\\/home\\/kos\\/RPServers\\/apache-tomcat\\/logs/-XX:HeapDumpPath=\\/home\\/kos\\/RPServers\\/apache-tomcat\\/logs -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5005/g' /home/kos/RPServers/apache-tomcat/bin/tomcat-start.sh";
